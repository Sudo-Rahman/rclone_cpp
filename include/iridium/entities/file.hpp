...
namespace iridium::rclone
{
    ...
    public:
        ...
        [[nodiscard]] file* parent() { return _parent; }
        ...
        [[nodiscard]] file* pointer() { return this; }
        ...
        [[nodiscard]] file* parent() const { return _parent; }

        [[nodiscard]] std::vector<std::shared_ptr<file>> children() const { return _children; }
