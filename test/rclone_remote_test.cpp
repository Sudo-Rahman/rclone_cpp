...
BOOST_AUTO_TEST_CASE(testRemoteEquality) {
        rclone_remote remote1("TestRemote", GoogleDrive, "/test/path");
        rclone_remote remote2("TestRemote", GoogleDrive, "/test/path");
...
BOOST_AUTO_TEST_CASE(testRemoteOutputOperator) {
        rclone_remote remote("TestRemote", GoogleDrive, "/test/path");
...
BOOST_AUTO_TEST_CASE(testRemoteCopyConstructor) {
        rclone_remote r("TestRemote", GoogleDrive, "/test/path");
