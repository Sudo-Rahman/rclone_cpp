...
BOOST_AUTO_TEST_SUITE(Suite)
	...
	{
		auto r_ptr = entity::remote::create_shared_ptr("TestRemote", entity::entity::remote::google_drive,
		                                               "/tests/path");
	...
	{
		auto r_ptr = entity::entity::remote::create_shared_ptr("TestRemote", entity::entity::remote::google_drive,
		                                                       "/tests/path");
	...
	BOOST_AUTO_TEST_CASE(testRcloneFileAddChild)
	{
		...
		file.add_child(entity::file::create_shared_ptr(&file, "child", 100, false,
