...
{
	option::tree::tree(const option::tree::flags& option) { _options.push_back(option::tree::to_string(option)); }
	...
	auto option::tree::to_string(option::tree::flags option) -> std::string
	{
		switch (option)
		{
	...
	auto option::tree::to_string(option::tree::flags_value option) -> std::string
	{
		switch (option)
		{
			case level:
	...
	auto option::filter::to_string(option::filter::flags option) -> std::string
	{
		switch (option)
		{
	...
	auto option::filter::to_string(option::filter::flags_value option) -> std::string
	{
		switch (option)
		{
