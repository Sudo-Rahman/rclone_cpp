...
namespace iridium::rclone
{
    ...
    std::ostream& operator<<(std::ostream& os, const entitie::file& file)
    {
    ...
    bool entitie::file::operator!=(const file& rhs) const { return !(rhs == *this); }

    bool entitie::file::operator==(const file& rhs) const
    {
    ...
    std::string entitie::file::absolute_path() const
    {
        std::string abs_path;
        if (_parent)
    ...
    std::string entitie::file::path() const
    {
        std::string path;
        if (_parent)
